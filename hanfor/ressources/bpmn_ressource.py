...
class BPMNResource(Ressource):
    ...
    def start_bpmn(self) -> None:
        requirement_ids = json.loads(self.request.args.get('requirement_ids'))
        ...
        for requirement_id in requirement_ids:
            ...
            # peas_tmp = BPMNRessource.create_phase_event_automata(requirement_id, var_collection, self.app)
        ...
        self.response.data = {'html': render_template('bpmn-modal/modal2.html', reqs=reqs)}
        return 
